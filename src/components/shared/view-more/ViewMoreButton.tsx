  ...
  return (
    <div className={styles.container}>
      <div className={isExpanded ? `expanded` : 'ellipsis lineclamp'}>
        ...
        {viewIcon && <img src={`${basePath}${viewIcon}`} alt="view-icon" />}
      </div>
      <button
      ...
      >
        {isExpanded ? (
          <>
            <span>닫기</span>
            <img src={`${basePath}/assets/images/icons/arrow-up.svg`} alt="up-arrow" />
          </>
        ) : (
          <>
            <span>더보기</span>
            <img src={`${basePath}/assets/images/icons/arrow-down.svg`} alt="up-arrow" />
          </>
        )}
      </button>
    </div>
